...
class ClimateBenchDataModule(pl.LightningDataModule):
    def __init__(
        self,
    ...
    def get_data_variables(self):
        return self.hparams.variables, self.hparams.out_variables
